...
<body class="bg-background">
    ...
    <!-- <header class="header flex justify-between px-5 py-2 bg-nav-color">
        <img src="{{ asset('images/Logo.png')}}" alt="logo" class="size-12 ml-1 inline cursor-pointer">
        <nav class="nav absolute flex flex-col md:flex-row bg-nav-color md:bg-transparent shadow-md md:shadow-none w-[80%] h-[50%] right-0 px-4 md:h-auto md:w-auto duration-500">
            <button class="close-nav text-text relative top-0 right-0 text-right text-3xl md:hidden">
                <i class="fa-solid fa-xmark"></i>
            </button>
            <form action="" method="GET" class="md:ml-auto">
                <input type="text" placeholder="Search movie.." name="query" class="bg-search-field-color border-none rounded-l-lg"><button type="submit" class="bg-search-btn-color p-2 text-text border-none rounded-r-lg">Search</button></input>
            </form>
            @if (Route::has('login'))
            <div class="mr-4 ">
        ...
        <button class="show-nav text-3xl text-text md:hidden">
            <i class="fa-solid fa-bars"></i>
        </button>
    </header> -->


    <footer class="bg-card-background absolute bottom-0 w-full">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-text uppercase dark:text-white">Follow us</h2>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Group 5™</a>. All Rights Reserved.
                </span>
    ...
    <!-- <footer>
        ...
        <ul>
            <h1>About</h1>
            <p>This application is made with PHP $ Laravel to create the best movie.review website on the planet.</p>
        </ul>
        <div class="vl"></div>
        <ul>
            <h1>Follow us</h1>
            <img src="{{ URL('images/github.png') }}" alt="github icon">
        </ul>
    </footer> -->
</body>
