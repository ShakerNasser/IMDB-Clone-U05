<section>
    <header>
        <h2 class="text-lg font-medium text-text dark:text-gray-100">
            {{ __('Profile Information') }}
        </h2>

        <p class="mt-1 text-sm text-text dark:text-gray-400">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div>
                <p class="text-sm mt-2 text-text dark:text-gray-200">
