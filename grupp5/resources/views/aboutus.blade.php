...
<body class="bg-background relative">
  ...
  <div class="absolute inset-x-0 top-1/4 transform -translate-y-1/2 text-center w-full">
    <section class="px-10 py-10">
      <h1 class="text-5xl font-bold mb-5 text-text"><span class="underline">About us</span></h1>
    </section>
  </div>

  <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 mt-28">
